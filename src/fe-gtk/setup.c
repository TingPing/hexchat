...
{
	gtkutil_file_req (_("Select Download Folder"), setup_filereq_cb, entry, gtk_entry_get_text (entry), NULL, FRF_CHOOSEFOLDER);
}
...
setup_entry_cb (GtkEntry *entry, setting *set)
{
	...
	char *p = g_strdup (gtk_entry_get_text (entry));
